...
public class ServicioAdicionalesException extends GenericException{
    ...
    public ServicioAdicionalesException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public ServicioAdicionalesException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
