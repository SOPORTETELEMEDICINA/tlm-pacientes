...
public class DomicilioException extends GenericException{
    ...
    public DomicilioException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public DomicilioException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
