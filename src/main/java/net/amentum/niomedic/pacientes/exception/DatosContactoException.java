...
public class DatosContactoException extends GenericException{
    ...
    public DatosContactoException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public DatosContactoException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
