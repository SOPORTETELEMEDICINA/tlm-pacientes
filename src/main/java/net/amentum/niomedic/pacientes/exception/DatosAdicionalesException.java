...
public class DatosAdicionalesException extends GenericException{
    ...
    public DatosAdicionalesException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public DatosAdicionalesException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
